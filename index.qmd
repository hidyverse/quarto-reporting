...
![](images/qmd_render_schema.png){fig-alt="illustration of quarto's rendering process" fig-align="center" style="margin-bottom: -40px; position: absolute; bottom: -.10px;" width="727"}
