...
![](images/rmarkdown_wizards.png){style="margin-top: -10px;" width="307"}
...
![](images/word.png){fig-alt="screenshot of blank word.docx" width="252"}
:::
...
::: {style="color: #8B0015; font-size: 1.5em"}
1.  Metadata
2.  Markup
3.  Code
4.  Output
