...
![](images/rmarkdown_wizards.png){style="margin-top: -10px;" width="1000"}
...
![](images/drakeMeme.jpeg){fig-alt="drake meme shaking head at copy/paste and encouraging source -> output models" fig-align="center"}
...
![](images/word.png){fig-alt="screenshot of blank word.docx" width="286"}
:::
...
::: {style="color: #8B0015; font-size: 1.2em"}
1.  Metadata
2.  Markup
3.  Code
4.  Output
...
RStudio should tell you when there are things to install...pay close attention!
:::
...
## And Beyond! {background-image="images/diveInQuarto.png," color="#E2E9EB," background-size="\"contain\","}
...
![](images/Screen%20Shot%202022-08-26%20at%2012.49.09%20PM.png){width="537"} 
[Curated list of Quarto docs, talks, tools, examples & articles](https://github.com/mcanouil/awesome-quarto)
